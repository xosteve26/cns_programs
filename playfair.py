...
def encryption(plainText, key):
    ...
    while i < len(plainText):
        ...
        print("PT", plainText[i], plainText[i+1])
...
def decrypt(cipherText, keyMatrix):
    ...
    cipherText = [x.strip() for x in cipherText if x.strip() != '']
    print(cipherText)

    i = 0
    while i < len(cipherText):
        # 2.1 calculate two grouped characters indexes from keyMatrix
        n1 = indexLocator(cipherText[i][0], keyMatrix)
        n2 = indexLocator(cipherText[i][2], keyMatrix)
        print("DEC", cipherText[i][0], cipherText[i][2])
        ...
        if n1[1] == n2[1]:
            ...
            i2 = (n2[0] - 1) % 5
            j2 = n2[1]
            decipherText.append(keyMatrix[i1][j1])
            decipherText.append(keyMatrix[i2][j2])
        ...
        # exchange columns of both value
            ...
            decipherText.append(keyMatrix[i1][j2])
            decipherText.append(keyMatrix[i2][j1])
